...
This component inherits parts and props from the [Alert Dialog primitive](/products/docs/components/alert-dialog) and is visually identical to [Dialog](/research/docs/components/dialog), though with differing semantics and behavior.
