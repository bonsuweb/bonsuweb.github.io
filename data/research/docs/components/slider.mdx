...
This component inherits props from the [Slider primitive](/products/docs/components/slider) and supports [common margin props](/research/docs/overview/layout#margin-props).
