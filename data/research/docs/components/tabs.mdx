...
This component inherits props from the [Tabs primitive](/products/docs/components/tabs) and supports [common margin props](/research/docs/overview/layout#margin-props).
