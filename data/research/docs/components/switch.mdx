...
This component inherits props from the [Switch primitive](/products/docs/components/switch) and supports [common margin props](/research/docs/overview/layout#margin-props).
