...
This component inherits props from the [Checkbox primitive](/products/docs/components/checkbox) and supports [common margin props](/research/docs/overview/layout#margin-props).
