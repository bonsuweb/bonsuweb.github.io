...
This component inherits props from the [Progress primitive](/products/docs/components/progress) and supports [common margin props](/research/docs/overview/layout#margin-props).
