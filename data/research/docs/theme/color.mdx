...
You can use the [custom color palette tool](/company/custom) to generate a custom palette based just on a couple reference colors. Once you are happy with the result, paste the generated CSS into your project. You can rename the generated colors to match the accent that you want to use in your theme.
...
<Text as="div" align="center" my="6">
	...
	{<a href="/company/custom">Create a custom palette →</a>}
</Text>
