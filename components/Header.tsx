...
import { BonsuLogoIcon } from "./BonsuLogoIcon";
					...
					>
						...
						>
							{mobileMenu.open ? (
								<NextLink href="/" passHref legacyBehavior>
									<BoxLink>
										<AccessibleIcon label="BONSU Homepage">
											<BonsuLogoIcon />
										</AccessibleIcon>
									</BoxLink>
								</NextLink>
						...
						<div className={styles.HeaderProductLinksContainer}>
							<HeaderProductLink
								href="/about-us"
								active={
									router.pathname.startsWith("/about-us") 
								}
							>
								About Us
							</HeaderProductLink>
							<HeaderProductLink
								href="/gallery"
								active={router.pathname.startsWith("/gallery")}
							>
								Gallery
							</HeaderProductLink>
							<HeaderProductLink
